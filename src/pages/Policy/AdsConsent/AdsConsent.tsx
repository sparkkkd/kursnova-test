				...
				<div className='policy-wrapper'>
					...
					<div className='container'>
						<p className='policy-p'>
							...
							(далее — Сайт), даю согласие на получение от ООО «Курснова» (ИНН:
							1683023468, ОГРН: 1241600045015, адрес электронной почты:{' '}
							<a className='link tdn' href='mailto:hello@kursnova.com'>
								hello@kursnova.com
							</a>
							) рекламных и информационных рассылок, в том числе, но не
							ограничиваясь, содержащих информацию о товарах и услугах, наличии
							специальных предложений, акций, розыгрышей, иных стимулирующих
							мероприятий, условиях, связанных с приобретением и использованием
							указанных товаров и услуг, о проведении мероприятий, презентаций,
							предложениях партнеров, а также информационных рассылок, в том
							числе, но не ограничиваясь, гайдов, чек-листов, презентаций и иных
							материалов, путем:
						</p>
						...
						<p className='policy-p'>
							...
							вправе отозвать согласие и отписаться от получения рассылок путем
							перехода по соответствующей ссылке, указанной в рассылке, либо
							путем направления запроса на эл. почту:{' '}
