				...
				<div className='policy-wrapper'>
					...
					<div className='container'>
						...
						<p className='policy-p'>
							...
							Оператор) контролировать доступность сервисов Сайта, анализировать
							данные, а также понимать, как развивать наши сервисы.
						</p>
						...
						<p className='policy-p'>
							...
							любом случае не превышает срока, необходимого для достижения целей
							обработки персональных данных.
						</p>

						<p className='policy-p'>
							При посещении Сайта Оператор запрашивает согласие Пользователя на
						...
						<p className='policy-p'>
							ВАЖНО: при отказе от использования файлов cookie отдельные функции
							Сайта могут быть недоступными, что повлияет на возможность
							использования Сайта.
						</p>
					</div>
				</div>
