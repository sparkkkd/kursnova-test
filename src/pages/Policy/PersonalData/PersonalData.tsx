				...
				<div className='policy-wrapper'>
					...
					<div className='container'>
						<p className='policy-p'>
							Настоящим я — полностью дееспособный гражданин, действуя свободно,
							своей волей и в своем интересе (далее — «Субъект»), даю согласие
							на обработку моих персональных данных, а также персональных данных
							моего несовершеннолетнего ребенка (если применимо) Обществу с
							ограниченной ответственностью «Курснова», ИНН: 1683023468, ОГРН:
							1241600045015, адрес: 420015, Республика Татарстан, г Казань, ул
							Карла Маркса, д. 51/14, помещ. 73 (именуется по тексту —
							«Оператор»,) на следующих условиях:
						</p>
					...
					<div className='table'>
						<div className='table-row'>
							<div className='bolder table-left'>Цель</div>
							<div className='bolder table-right'>
					...
					<div className='container'>
						...
						<p className='policy-p'>
							Оператор прекращает обработку персональных данных и уничтожает их
							в срок, не превышающий 30 дней с даты поступления отзыва.
						</p>

						<h5 className='subtitle'>Заключительные положения:</h5>

						<p className='policy-p'>
							Я полностью ознакомился с текстом настоящего согласия, включая все
							ссылки, и согласен с его условиями. Подробные условия обработки
							персональных данных содержатся в Политике конфиденциальности.
						</p>

						<p className='policy-p'>
							Все термины, которые не указаны в настоящем согласии, трактуются в
							соответствии с Политикой конфиденциальности и Пользовательском
							соглашении.
						</p>

						<p className='policy-p'>
							Согласие считается предоставленным с момента совершения одного из
							следующих действий:
						</p>
